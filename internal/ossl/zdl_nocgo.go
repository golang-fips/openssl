...
func Dlopen(path *byte, flags int32) unsafe.Pointer {
	r0, _ := syscallN(0, _mkcgo_dlopen_trampoline_addr, uintptr(mkcgoEscapePtr(unsafe.Pointer(path))), uintptr(flags))
...
func Dlsym(handle unsafe.Pointer, symbol *byte) unsafe.Pointer {
	r0, _ := syscallN(0, _mkcgo_dlsym_trampoline_addr, uintptr(handle), uintptr(mkcgoEscapePtr(unsafe.Pointer(symbol))))
	return unsafe.Pointer(r0)
}
