...
long _mkcgo_BIO_ctrl(_BIO_PTR, int, long, void*);
int _mkcgo_BIO_free(_BIO_PTR);
_BIO_PTR _mkcgo_BIO_new(const _BIO_METHOD_PTR, uintptr_t *);
const _BIO_METHOD_PTR _mkcgo_BIO_s_mem(void);
_BIGNUM_PTR _mkcgo_BN_bin2bn(const unsigned char*, int, _BIGNUM_PTR, uintptr_t *);
int _mkcgo_BN_bn2binpad(const _BIGNUM_PTR, unsigned char*, int, uintptr_t *);
int _mkcgo_BN_bn2lebinpad(const _BIGNUM_PTR, unsigned char*, int, uintptr_t *);
void _mkcgo_BN_clear(_BIGNUM_PTR);
void _mkcgo_BN_clear_free(_BIGNUM_PTR);
void _mkcgo_BN_free(_BIGNUM_PTR);
_BIGNUM_PTR _mkcgo_BN_lebin2bn(const unsigned char*, int, _BIGNUM_PTR, uintptr_t *);
_BIGNUM_PTR _mkcgo_BN_new(uintptr_t *);
int _mkcgo_BN_num_bits(const _BIGNUM_PTR);
void _mkcgo_CRYPTO_free(void*, const char*, int);
void* _mkcgo_CRYPTO_malloc(size_t, const char*, int, uintptr_t *);
void _mkcgo_DSA_free(_DSA_PTR);
int _mkcgo_DSA_generate_key(_DSA_PTR, uintptr_t *);
...
_DSA_PTR _mkcgo_DSA_new(uintptr_t *);
int _mkcgo_DSA_set0_key(_DSA_PTR, _BIGNUM_PTR, _BIGNUM_PTR, uintptr_t *);
int _mkcgo_DSA_set0_pqg(_DSA_PTR, _BIGNUM_PTR, _BIGNUM_PTR, _BIGNUM_PTR, uintptr_t *);
void _mkcgo_EC_GROUP_free(_EC_GROUP_PTR);
_EC_GROUP_PTR _mkcgo_EC_GROUP_new_by_curve_name(int, uintptr_t *);
int _mkcgo_EC_KEY_check_key(const _EC_KEY_PTR, uintptr_t *);
...
_EC_KEY_PTR _mkcgo_EC_KEY_new_by_curve_name(int, uintptr_t *);
int _mkcgo_EC_KEY_set_private_key(_EC_KEY_PTR, const _BIGNUM_PTR, uintptr_t *);
int _mkcgo_EC_KEY_set_public_key(_EC_KEY_PTR, const _EC_POINT_PTR, uintptr_t *);
int _mkcgo_EC_KEY_set_public_key_affine_coordinates(_EC_KEY_PTR, _BIGNUM_PTR, _BIGNUM_PTR, uintptr_t *);
void _mkcgo_EC_POINT_free(_EC_POINT_PTR);
int _mkcgo_EC_POINT_get_affine_coordinates_GFp(const _EC_GROUP_PTR, const _EC_POINT_PTR, _BIGNUM_PTR, _BIGNUM_PTR, _BN_CTX_PTR, uintptr_t *);
int _mkcgo_EC_POINT_mul(const _EC_GROUP_PTR, _EC_POINT_PTR, const _BIGNUM_PTR, const _EC_POINT_PTR, const _BIGNUM_PTR, _BN_CTX_PTR, uintptr_t *);
_EC_POINT_PTR _mkcgo_EC_POINT_new(const _EC_GROUP_PTR, uintptr_t *);
int _mkcgo_EC_POINT_oct2point(const _EC_GROUP_PTR, _EC_POINT_PTR, const unsigned char*, size_t, _BN_CTX_PTR, uintptr_t *);
size_t _mkcgo_EC_POINT_point2oct(const _EC_GROUP_PTR, const _EC_POINT_PTR, point_conversion_form_t, unsigned char*, size_t, _BN_CTX_PTR, uintptr_t *);
...
int _mkcgo_EVP_CIPHER_CTX_ctrl(_EVP_CIPHER_CTX_PTR, int, int, void*, uintptr_t *);
void _mkcgo_EVP_CIPHER_CTX_free(_EVP_CIPHER_CTX_PTR);
_EVP_CIPHER_CTX_PTR _mkcgo_EVP_CIPHER_CTX_new(uintptr_t *);
int _mkcgo_EVP_CIPHER_CTX_set_key_length(_EVP_CIPHER_CTX_PTR, int, uintptr_t *);
int _mkcgo_EVP_CIPHER_CTX_set_padding(_EVP_CIPHER_CTX_PTR, int, uintptr_t *);
_EVP_CIPHER_PTR _mkcgo_EVP_CIPHER_fetch(_OSSL_LIB_CTX_PTR, const char*, const char*, uintptr_t *);
...
int _mkcgo_EVP_DigestVerifyInit(_EVP_MD_CTX_PTR, _EVP_PKEY_CTX_PTR*, const _EVP_MD_PTR, _ENGINE_PTR, _EVP_PKEY_PTR, uintptr_t *);
int _mkcgo_EVP_EncryptFinal_ex(_EVP_CIPHER_CTX_PTR, unsigned char*, int*, uintptr_t *);
int _mkcgo_EVP_EncryptInit_ex(_EVP_CIPHER_CTX_PTR, const _EVP_CIPHER_PTR, _ENGINE_PTR, const unsigned char*, const unsigned char*, uintptr_t *);
int _mkcgo_EVP_EncryptUpdate(_EVP_CIPHER_CTX_PTR, unsigned char*, int*, const unsigned char*, int, uintptr_t *);
void _mkcgo_EVP_KDF_CTX_free(_EVP_KDF_CTX_PTR);
size_t _mkcgo_EVP_KDF_CTX_get_kdf_size(_EVP_KDF_CTX_PTR, uintptr_t *);
_EVP_KDF_CTX_PTR _mkcgo_EVP_KDF_CTX_new(_EVP_KDF_PTR, uintptr_t *);
int _mkcgo_EVP_KDF_CTX_set_params(_EVP_KDF_CTX_PTR, const _OSSL_PARAM_PTR, uintptr_t *);
...
int _mkcgo_EVP_MAC_CTX_set_params(_EVP_MAC_CTX_PTR, const _OSSL_PARAM_PTR, uintptr_t *);
_EVP_MAC_PTR _mkcgo_EVP_MAC_fetch(_OSSL_LIB_CTX_PTR, const char*, const char*, uintptr_t *);
...
int _mkcgo_EVP_PKEY_CTX_add1_hkdf_info(_EVP_PKEY_CTX_PTR, const unsigned char*, int, uintptr_t *);
...
_DSA_PTR _mkcgo_EVP_PKEY_get0_DSA(_EVP_PKEY_PTR, uintptr_t *);
...
int _mkcgo_EVP_PKEY_keygen_init(_EVP_PKEY_CTX_PTR, uintptr_t *);
_EVP_PKEY_PTR _mkcgo_EVP_PKEY_new(uintptr_t *);
_EVP_PKEY_PTR _mkcgo_EVP_PKEY_new_raw_private_key(int, _ENGINE_PTR, const unsigned char*, size_t, uintptr_t *);
_EVP_PKEY_PTR _mkcgo_EVP_PKEY_new_raw_public_key(int, _ENGINE_PTR, const unsigned char*, size_t, uintptr_t *);
int _mkcgo_EVP_PKEY_paramgen(_EVP_PKEY_CTX_PTR, _EVP_PKEY_PTR*, uintptr_t *);
int _mkcgo_EVP_PKEY_paramgen_init(_EVP_PKEY_CTX_PTR, uintptr_t *);
int _mkcgo_EVP_PKEY_private_check(_EVP_PKEY_CTX_PTR, uintptr_t *);
int _mkcgo_EVP_PKEY_public_check_quick(_EVP_PKEY_CTX_PTR, uintptr_t *);
int _mkcgo_EVP_PKEY_set1_EC_KEY(_EVP_PKEY_PTR, _EC_KEY_PTR, uintptr_t *);
int _mkcgo_EVP_PKEY_set1_encoded_public_key(_EVP_PKEY_PTR, const unsigned char*, size_t, uintptr_t *);
int _mkcgo_EVP_PKEY_sign(_EVP_PKEY_CTX_PTR, unsigned char*, size_t*, const unsigned char*, size_t, uintptr_t *);
int _mkcgo_EVP_PKEY_sign_init(_EVP_PKEY_CTX_PTR, uintptr_t *);
int _mkcgo_EVP_PKEY_up_ref(_EVP_PKEY_PTR, uintptr_t *);
int _mkcgo_EVP_PKEY_verify(_EVP_PKEY_CTX_PTR, const unsigned char*, size_t, const unsigned char*, size_t, uintptr_t *);
int _mkcgo_EVP_PKEY_verify_init(_EVP_PKEY_CTX_PTR, uintptr_t *);
_EVP_SIGNATURE_PTR _mkcgo_EVP_SIGNATURE_fetch(_OSSL_LIB_CTX_PTR, const char*, const char*, uintptr_t *);
...
int _mkcgo_FIPS_mode_set(int, uintptr_t *);
int _mkcgo_HMAC_CTX_copy(_HMAC_CTX_PTR, _HMAC_CTX_PTR, uintptr_t *);
...
int _mkcgo_OPENSSL_init_crypto(uint64_t, const _OPENSSL_INIT_SETTINGS_PTR, uintptr_t *);
...
const _OSSL_PARAM_PTR _mkcgo_OSSL_PARAM_locate_const(const _OSSL_PARAM_PTR, const char*, uintptr_t *);
...
_OSSL_PROVIDER_PTR _mkcgo_OSSL_PROVIDER_try_load(_OSSL_LIB_CTX_PTR, const char*, int, uintptr_t *);
...
_RSA_PTR _mkcgo_RSA_new(uintptr_t *);
int _mkcgo_RSA_set0_crt_params(_RSA_PTR, _BIGNUM_PTR, _BIGNUM_PTR, _BIGNUM_PTR, uintptr_t *);
int _mkcgo_RSA_set0_factors(_RSA_PTR, _BIGNUM_PTR, _BIGNUM_PTR, uintptr_t *);
int _mkcgo_RSA_set0_key(_RSA_PTR, _BIGNUM_PTR, _BIGNUM_PTR, _BIGNUM_PTR, uintptr_t *);
