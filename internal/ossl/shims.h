...
_OSSL_PARAM_PTR EVP_MD_CTX_gettable_params(const _EVP_MD_CTX_PTR ctx) __attribute__((tag("3")));
_OSSL_PARAM_PTR EVP_MD_CTX_settable_params(const _EVP_MD_CTX_PTR ctx) __attribute__((tag("3")));
