...
func MkcgoLoad_3(handle unsafe.Pointer) {
	...
	_mkcgo_EVP_PKEY_Q_keygen, _ = Dlsym(handle, unsafe.StringData("EVP_PKEY_Q_keygen\x00"))
...
func MkcgoLoad_legacy_1(handle unsafe.Pointer) {
	...
	_mkcgo_EVP_CIPHER_get_block_size, _ = Dlsym(handle, unsafe.StringData("EVP_CIPHER_block_size\x00"))
	_mkcgo_EVP_MD_get_block_size, _ = Dlsym(handle, unsafe.StringData("EVP_MD_block_size\x00"))
	_mkcgo_EVP_MD_get_size, _ = Dlsym(handle, unsafe.StringData("EVP_MD_size\x00"))
	...
	_mkcgo_EVP_PKEY_get_bits, _ = Dlsym(handle, unsafe.StringData("EVP_PKEY_bits\x00"))
	_mkcgo_EVP_PKEY_get_size, _ = Dlsym(handle, unsafe.StringData("EVP_PKEY_size\x00"))
