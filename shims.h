...
int EVP_MD_size(const _EVP_MD_PTR md) __attribute__((tag("legacy_1")));
int EVP_MD_get_size(const _EVP_MD_PTR md) __attribute__((tag("3")));
int EVP_MD_block_size(const _EVP_MD_PTR md) __attribute__((tag("legacy_1")));
int EVP_MD_get_block_size(const _EVP_MD_PTR md) __attribute__((tag("3")));
...
int EVP_CIPHER_block_size(const _EVP_CIPHER_PTR cipher) __attribute__((tag("legacy_1")));
int EVP_CIPHER_get_block_size(const _EVP_CIPHER_PTR cipher) __attribute__((tag("3")));
...
int EVP_PKEY_size(const _EVP_PKEY_PTR pkey) __attribute__((tag("legacy_1")));
int EVP_PKEY_get_size(const _EVP_PKEY_PTR pkey) __attribute__((tag("3")));
int EVP_PKEY_bits(const _EVP_PKEY_PTR pkey) __attribute__((tag("legacy_1")));
int EVP_PKEY_get_bits(const _EVP_PKEY_PTR pkey) __attribute__((tag("3"))); 
...
_EVP_PKEY_PTR EVP_PKEY_Q_keygen(_OSSL_LIB_CTX_PTR ctx, const char *propq, const char *type) __attribute__((tag("3"),variadic("EVP_PKEY_Q_keygen")));
